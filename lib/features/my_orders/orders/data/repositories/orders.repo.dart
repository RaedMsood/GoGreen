...
import 'package:gogreen/features/my_orders/orders/data/model/order_details/order_detail_vehicle_and_review_model.dart';
  ...
  Future<DataState<OrderDetailModel>> getOrderDetail({required int id}) async {
    return await WingsRemoteService().send(
      ...
      onSuccess: (response, code) {
        ...
        data['review'] = null;
        OrderDetailReview.empty().toJson();
        print(data['order_products']);
