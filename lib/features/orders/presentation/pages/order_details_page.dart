...
import 'package:gogreen/features/orders/presentation/widget/card_design_for_order_details_widget.dart';
import 'package:gogreen/features/orders/presentation/widget/order_details_shimmer_widget.dart';

import '../widget/bill_of_order_details_widget.dart';
import '../widget/design_of_order_requests_widget.dart';
import '../widget/evaluation_of_order_details_widget.dart';
...
class OrderDetailsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    double tempRates =
        (double.parse(controller.data.company.rates.toString()) * 10)
                .truncate() /
            10;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Check the order status. if it is successful, the evaluation will be displayed
                    if (controller.data.status.status == 5)
                      EvaluationOfOrderDetailsWidget(
                        id: controller.data.company.id,
                        companyImage: controller.data.company.image.toString(),
                        companyName: controller.data.company.name.toString(),
                        companyAddress:
                            controller.data.company.address.toString(),
                        evaluation: tempRates,
                      ),
                    // Class Bill Of Order Details Widget
                    BillOfOrderDetailsWidget(
                      orderStatus: controller.data.status.name,
                      orderNumber:
